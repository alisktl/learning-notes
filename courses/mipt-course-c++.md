...
1. [2. Основные типы и операции над ними.](#основные-типы-и-операции-над-ними)
2. [3. Объявления, определения и области видимости. Выражения и операторы.](#объявления-определения-и-области-видимости-выражения-и-операторы)
3. [4. Выражения и операторы. Управляющие конструкции. Ошибки компиляции.](#выражения-и-операторы-управляющие-конструкции-ошибки-компиляции)
4. [5. Runtime errors, undefined behaviour. Указатели и операции над ними.](#runtime-errors-undefined-behaviour-указатели-и-операции-над-ними)
5. [6. Виды памяти. Массивы. Перегрузка функций](#виды-памяти-массивы-перегрузка-функций)
6. [7. Указатели на функции. Ссылки. Константы](#указатели-на-функции-ссылки-константы)
7. [8. Приведения типов. Классы и структуры. Модификаторы доступа](#приведения-типов-классы-и-структуры-модификаторы-доступа)
8. [9. Конструкторы, деструкторы, оператор присваивания и "правило трех"](#конструкторы-деструкторы-оператор-присваивания-и-правило-трех)
9. [10. Перегрузка операторов, константные и статические методы](#перегрузка-операторов-константные-и-статические-методы)
10. [11. Указатели на члены. Енумы. Наследование (начало)]()
...
# 6. Виды памяти. Массивы. Перегрузка функций
...
# 7. Указатели на функции. Ссылки. Константы
...
# 8. Приведения типов. Классы и структуры. Модификаторы доступа
...
# 9. Конструкторы, деструкторы, оператор присваивания и "правило трех"
...
int main() {
    ...
    static_cast<Father &>(m); // Compilation Error, не может кастить в бок
    static_cast<Son &>(m); // Compilation Error, не может кастить сверху вниз
    dynamic_cast<Father &>(m); // Works good, каст в бок
    dynamic_cast<Son &>(m); // Works good, каст сверху вниз
    reinterpret_cast<Father &>(m); // Undefined Behavior
    reinterpret_cast<Son &>(m); // Undefined Behavior
}
```

### Example 2:
`reinterpret_cast` игнорирует приватность
```
struct Granny {
    virtual ~Granny() = default;
};
...
struct Son : public Mother, private Father {
};
